...
exports.handler = async function (payload) {
    ...
    for (const evt of events) {
        ...
        if (isEVMCall === true) {
            ...
            let NODE_URL_SEPOLIA = 'https://sepolia.infura.io/v3/REDACTED';
            let NODE_URL_CHIADO = 'https://rpc.chiado.gnosis.gateway.fm/';
            let NODE_URL_MUMBAI = 'https://polygon-mumbai.infura.io/v3/REDACTED';
            let NODE_URL_OPTIMISM = 'https://optimism-mainnet.infura.io/v3/REDACTED';
            let NODE_URL_GNOSIS = 'https://rpc.gnosis.gateway.fm/';
            let NODE_URL_POLYGON = 'https://polygon-mainnet.infura.io/v3/REDACTED';
